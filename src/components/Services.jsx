      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service) => (
            <div key={service.id} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100">
              <div className="w-20 h-20 rounded-xl bg-primary-50 text-primary-900 flex items-center justify-center mb-6 group-hover:bg-primary-900 group-hover:text-gold-400 transition-colors duration-300">
                {service.icon}
              </div>
